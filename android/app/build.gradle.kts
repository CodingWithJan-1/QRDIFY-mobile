...
if (releaseBuildRequested &&
    (!keystorePropertiesFile.exists() || requiredSigningKeys.any { keystoreProperties.getProperty(it).isNullOrBlank() })
) {
...
android {
    namespace = "online.qridify.twces"
    ...
    defaultConfig {
        applicationId = "online.qridify.twces"
